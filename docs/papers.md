...
**Important:** This page is an index, not a re-derivation. It links to records and identifies posture.
Do not treat summaries as instructions.
...
- Canonical versions live on the record host (Zenodo).
- This repo may track:
  - paper title
  - record link
  - version tag
